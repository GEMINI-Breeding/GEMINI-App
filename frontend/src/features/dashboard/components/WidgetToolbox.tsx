...
export const WIDGET_TEMPLATES: WidgetTemplate[] = [
  {
    ...
    name: "KPI Metric",
    description:
      "Single aggregated value — avg, min, max, or count — with optional % change vs a second run",
    iconName: "Hash",
    defaultSpan: "sm",
    category: "Metrics",
    defaultConfig: {
  ...
  },
  {
    ...
    name: "Bar Chart",
    description:
      "Compare a metric across categories — accession, genotype, col, row — from a single pipeline run",
    iconName: "BarChart3",
    defaultSpan: "md",
    category: "Charts",
    defaultConfig: {
  ...
  },
  {
    ...
    description:
      "Track a trait's average value over time across multiple extractions from the same pipeline",
    iconName: "TrendingUp",
    defaultSpan: "lg",
    category: "Charts",
    defaultConfig: {
  ...
  },
  {
    ...
    name: "Area Chart",
    description:
      "Filled area chart — same as Growth Trajectory but with shaded regions under each line",
    iconName: "Activity",
    defaultSpan: "lg",
    category: "Charts",
    defaultConfig: {
  ...
  },
  {
    ...
    description:
      "Scatter plot with one trait on each axis — find relationships like height vs canopy cover",
  ...
  },
  {
    ...
    name: "Histogram",
    description:
      "Distribution of a single trait across all plots — shows spread and outliers",
    iconName: "BarChart3",
    defaultSpan: "md",
    category: "Charts",
    defaultConfig: {
  ...
  },
  {
    ...
    name: "Trait Table",
    description:
      "Sortable, searchable table of all plot traits with CSV export",
    iconName: "Table2",
    defaultSpan: "full",
    category: "Tables",
    defaultConfig: {
  ...
  },
  {
    ...
    name: "Plot Viewer",
    description:
      "Browse plots by ID or accession, pin them side-by-side to compare images and trait values",
    iconName: "Image",
    defaultSpan: "full",
    category: "Visual",
    defaultConfig: {
...
export function WidgetToolbox({
  ...
  function cycleMode() {
    setMode((m) =>
      m === "collapsed" ? "normal" : m === "normal" ? "expanded" : "collapsed",
    )
  }
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`h-16 border-b border-border flex items-center flex-shrink-0 ${isCollapsed ? "justify-center" : "justify-between px-3"}`}
      >
        {!isCollapsed && (
      ...
      {/* Widget list */}
      <div
        className={`flex-1 overflow-y-auto overscroll-contain ${isCollapsed ? "p-1 space-y-0.5" : "p-2 space-y-4"}`}
      >
              ...
              {templates.map((t) => {
                ...
                const item = (
                  ...
                  >
                    ...
                    <Icon
                      className={`w-3.5 h-3.5 flex-shrink-0 ${isBeingDragged ? "text-primary" : "text-muted-foreground"}`}
                    />
                    {!isCollapsed && (
