...
export function GwasJobDetail({ studyId, jobId }: GwasJobDetailProps) {
  ...
  const kinshipHeatmapSrc = s3UrlToDownload(result?.artifacts?.kinship_heatmap)
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                {stage &&
                  (statusLower === "pending" || statusLower === "running") && (
            ...
            <>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                  ...
                  <Stat
                    label="PCs used"
                    value={String(result.n_pcs_used ?? 0)}
                  />
                  <Stat
              ...
              {pcaSrc && (
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-3 text-xs">
                    PC1 vs PC2 of the QC'd genotype matrix. Hover any point to
                    see the accession name. Clusters indicate subpopulation
                    structure — useful for sanity-checking the n_pcs covariates
                    the model was given.
                  </p>
                  <PcaPlot src={pcaSrc} />
                </section>
              ...
              {kinshipHeatmapSrc && (
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-3 text-xs">
                    ...
                    clustered so related samples form visible blocks. Diagonal
                    is each sample's relatedness with itself; the colour scale
                    is symmetric around zero (red = related, blue =
                    anti-related). Click the image to open full-size.
                  </p>
                  <div className="rounded border bg-white">
                    <AuthImage
