...
concurrently \
    ...
    "cd /app/GEMINI-Flask-Server && /app/GEMINI-Flask-Server/.conda/bin/python src/app_flask_backend.py \
    --data_root_dir /root/GEMINI-App-Data --flask_port ${REACT_APP_FLASK_PORT:-5000} \
    --titiler_port ${REACT_APP_TILE_SERVER_PORT:-8091}"