    ...
    <ThemeProvider theme={darkTheme}>
      <Box sx={{ display: 'flex', flexDirection: 'row' }}>
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 2, paddingLeft: 0, paddingBottom: 2 }}>
            <IconButton 
              color="white"
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 2, paddingLeft: 0, paddingBottom: 1 }}>
            <IconButton 
              color="white"
              aria-label="prep"
            ...
            >
              <PictureInPictureIcon color={currentView === 1 ? "secondary" : "white"} fontSize='medium'/>
            </IconButton>
            <Typography variant="body" color={currentView === 1 ? "secondary" : "white"} align="center" sx={{ fontSize: '14px' }}>Prep</Typography>
          </Box>
          
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingRight: 0, paddingLeft: 0, paddingBottom: 1 }}>
            <IconButton 
              color="white" 
              aria-label="stats" 
            ...
            >
              <InsightsIcon color={currentView === 2 ? "secondary" : "white"} fontSize='medium'/>
            </IconButton>
            <Typography variant="body" color={currentView === 2 ? "secondary" : "white"} align="center" sx={{ fontSize: '14px' }}>Stats</Typography>
          </Box>

          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 0.75, paddingRight: 0, paddingLeft: 0, paddingBottom: 1 }}>
            <IconButton 
                color="white" 
                aria-label="map" 
            ...
            <Typography variant="body" color={currentView === 0 ? "secondary" : "white"} align="center" sx={{ fontSize: '14px' }}>Map</Typography>
          </Box>
